...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __('No Repeat', 'mdframework'),
		'repeat-x'  => __('Repeat Horizontally', 'mdframework'),
		'repeat-y'  => __('Repeat Vertically', 'mdframework'),
		'repeat'    => __('Repeat All', 'mdframework'),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __('Top Left', 'mdframework'),
		'top center'    => __('Top Center', 'mdframework'),
		'top right'     => __('Top Right', 'mdframework'),
		'center left'   => __('Middle Left', 'mdframework'),
		'center center' => __('Middle Center', 'mdframework'),
		'center right'  => __('Middle Right', 'mdframework'),
		'bottom left'   => __('Bottom Left', 'mdframework'),
		'bottom center' => __('Bottom Center', 'mdframework'),
		'bottom right'  => __('Bottom Right', 'mdframework')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __('Scroll Normally', 'mdframework'),
		'fixed'  => __('Fixed in Place', 'mdframework')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __('Normal', 'mdframework'),
		'italic'      => __('Italic', 'mdframework'),
		'bold'        => __('Bold', 'mdframework'),
		'bold italic' => __('Bold Italic', 'mdframework')
		);
