...
<aside class="videoclan">
	...
	<div class="vecchiotorneo"><img src="<?php echo get_template_directory_uri();?>/images/up.png" alt="next turnament"/></div>
	<div id="turnament">
	<?php
		query_posts( array(
	...
	<div class="nuovotorneo"><img src="<?php echo get_template_directory_uri();?>/images/down.png" alt="previous turnament"/></div>
</aside>
